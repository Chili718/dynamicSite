  ...
  <body>
    ...
    <div id="home" class="parallaxstart" data-parallax="scroll" data-z-index="0" data-image-src="images/main.jpg" data-natural-width="3233" data-natural-height="3403">
        <div class="image-anim">
          <svg id="nim" width="518" height="107" viewBox="0 0 518 107" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="about">
      ...
      <div>
        <img class="picofme" src="images/picofme.png" width="150" height="150">
      </div>
